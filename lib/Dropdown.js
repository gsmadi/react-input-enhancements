...
var Dropdown = function (_PureComponent) {
  ...
  function Dropdown(props) {
    ...
    _this.renderOption = function (opt, idx) {
      ...
      var hovered = idx === _this.state.hoveredIndex;
      ...
      return _react2.default.createElement(
        _DropdownOption2.default,
        {
          ...
          onMouseOver: _this.highlightOnMouseOver.bind(_this, idx),
          onMouseLeave: _this.resetHoveredOption.bind(_this, idx),
          highlighted: highlighted
        },
        onRenderOption(_this.styling, opt, highlighted, disabled, hovered)
      );
    };
  ...
  (0, _createClass3.default)(Dropdown, [{
    ...
    value: function highlightOnMouseOver(idx) {
      var option = this.state.shownOptions[idx];
      var index = findOptionIndex(this.props.options, option);

      this.setState({ hoveredIndex: index });
    }
  }, {
    key: 'resetHoveredOption',
    value: function resetHoveredOption() {
...
Dropdown.defaultProps = {
  onRenderOption: function onRenderOption(styling, opt, highlighted, disabled, hovered) {
    return opt !== null ? _react2.default.createElement(
      'div',
      styling('inputEnhancementsOption', highlighted, disabled, hovered),
      (0, _getOptionLabel2.default)(opt, highlighted, disabled, hovered)
  ...
  optionFilters: [filters.filterByMatchingTextWithThreshold(100), filters.sortByMatchingText, filters.limitBy(100), filters.notFoundMessage('No matches found'), filters.filterRedudantSeparators]
};
