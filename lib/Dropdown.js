    ...
    _this.renderOption = function (opt, idx) {
      ...
      return _react2.default.createElement(
        _DropdownOption2.default,
        {
          ...
          onMouseOver: _this.handleHover.bind(_this, idx),
          onMouseLeave: _this.handleHoverLeave.bind(_this),
...
Dropdown.defaultProps = {
  ...
  optionFilters: [filters.filterByMatchingTextWithThreshold(100), filters.sortByMatchingText, filters.notFoundMessage('No matches found'), filters.filterRedudantSeparators]
};
